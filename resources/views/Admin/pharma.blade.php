	...
	<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
		...
		<div class="list-group">
			...
			<main class="content">
				...
				<div class="mb-3">
					<h1 class="h3 d-inline align-middle las la-pills">Pharmatists</h1></div>
				<div class="tan">
				<div class="bth">
		<button type="button" class="btn btn-primary" onclick="openpopup()">Add New<span data-feather="plus"></span></button></div>
                       ...
                       <div class="tbn">
						<table class="table table-bordered">
							...
							<tbody>
							  <tr>
								<th scope="row"><img src="../../../public/images/4140039.png" style="width:40px;"></th>
								<td>276</td>
								<td>Ahmed mahmud</td>
								<td>01111268003</td>
								<td>Ahmed_mahmud@gmail.com</td>
